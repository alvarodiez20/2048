...
def main():
    ...
    parser.add_argument('--epsilon-decay', type=int, default=500000, help='Epsilon decay steps')
    parser.add_argument('--batch-size', type=int, default=256, help='Batch size')
    parser.add_argument('--buffer-size', type=int, default=500000, help='Replay buffer size')
